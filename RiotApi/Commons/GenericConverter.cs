    ...
    public static class GenericConverter
    {
        ...
        public static string LeagueQueueTypeToString(Enums.LeagueQueueType leagueQueueType)
        {
            switch (leagueQueueType)
            {
                ...
                case Enums.LeagueQueueType.RANKED_TEAM_3x3:
                    return "RANKED_TEAM_3x3";
                case Enums.LeagueQueueType.RANKED_TEAM_5x5:
        ...
        public static Enums.LeagueQueueType StringToLeagueQueueType(string leagueQueueType)
        {
            switch (leagueQueueType)
            {
                ...
                case "RANKED_TEAM_3x3":
                    return Enums.LeagueQueueType.RANKED_TEAM_3x3;
                case "RANKED_TEAM_5x5":
                    return Enums.LeagueQueueType.RANKED_TEAM_5x5;
                default:
        ...
        public static Enums.SeasonType StringToSeasonType(string seasonType)
        {
            switch (seasonType)
            {
                ...
                case "UNKNOWN":
                default:
                    return Enums.SeasonType.UNKNOWN;
            }
        }
        ...
        public static Enums.SeasonNoPreSeasonType StringToSeasonNoPreSeasonType(string seasonNoPreSeasonType)
        {
            switch (seasonNoPreSeasonType)
            {
                case "SEASON2017":
                    return Enums.SeasonNoPreSeasonType.SEASON2017;
                case "SEASON2016":
                    return Enums.SeasonNoPreSeasonType.SEASON2016;
                case "SEASON2014":
                    return Enums.SeasonNoPreSeasonType.SEASON2014;
                case "SEASON2015":
                    return Enums.SeasonNoPreSeasonType.SEASON2015;
                case "SEASON3":
                    return Enums.SeasonNoPreSeasonType.SEASON3;
                default:
                    throw new InvalidEnumArgumentException(seasonNoPreSeasonType);
            }
        }
